...
exports.metricNames = exports.heapSpacesSizeAndUsed = void 0;
const v8 = require("v8");
...
const heapSpacesSizeAndUsed = (meter, { prefix, labels }) => {
    const labelsBySpace = {};
    let stats;
    function getStats() {
        if (stats !== undefined)
...
exports.heapSpacesSizeAndUsed = heapSpacesSizeAndUsed;
exports.metricNames = Object.values(NODEJS_HEAP_SIZE);
